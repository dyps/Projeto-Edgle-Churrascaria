...
public class CriarPedidoTipoMesaPage extends AbstractPage {

	public CriarPedidoTipoMesaPage(WebDriver driver) {
		super(driver);
	}
	
	public CriarPedidoTipoMesaPage setObservacao(String observacao) {
		setInputText("idFormObservacao:idObservacao", observacao);
		return this;
	}
	
	public CriarPedidoTipoMesaPage selecionarCategoriaDoProduto() {
	...
	public CriarPedidoTipoMesaPage cancelarItem() {
