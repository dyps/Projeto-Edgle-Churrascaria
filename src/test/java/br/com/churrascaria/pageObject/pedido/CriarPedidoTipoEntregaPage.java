...
public class CriarPedidoTipoEntregaPage extends AbstractPage {

	public CriarPedidoTipoEntregaPage(WebDriver driver) {
		super(driver);
	}
	
	public CriarPedidoTipoEntregaPage setObservacao(String observacao) {
		setInputText("idFormObservacao:idObservacao", observacao);
		return this;
	}
	
	public CriarPedidoTipoEntregaPage selecionarCategoriaDoProduto() {
	...
	public CriarPedidoTipoEntregaPage cancelarItem() {
